...
public class step6_34_123 {
	...
	public static void main(String[] args) throws Exception {
		...
		//		BufferedWriter out2 = new BufferedWriter(new FileWriter("output/step341/outbefore342.txt"));
	...
	private static void printoutputcluster(HashMap<String, HashMap<String, Object>> hooksAndClusters, Gson gson) throws IOException {
		BufferedWriter out22 = new BufferedWriter(new FileWriter("output/step341/finish.txt"));
